...
import '../../widgets/smart_flare_animation.dart';
...
class _CalendarState extends State<Calendar> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    Provider.of<Singleton>(context, listen: false).selectedEvents = _events[_selectedDay] ?? [];
  ...
  void _onDaySelected(DateTime day, List events, List holidays) =>
      setState(() {
        Provider.of<Singleton>(context, listen: false).selectedEvents = events;
  ...
  Column taskBody() =>
      Column(
          ...
          children: [
            ...
            Column(
              children: Provider.of<Singleton>(context, listen: false).selectedEvents.map((event) => taskList(
                  "Задача ${Provider.of<Singleton>(context, listen: false).selectedEvents.indexOf(event) + 1}",
                  event.toString(),
